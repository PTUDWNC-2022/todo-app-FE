		...
		<li
			...
			<div className="column-dropdown-actions">
				<Dropdown>
					...
					<Dropdown.Menu>
						<Dropdown.Item>
							<i class="bi bi-brightness-high"></i>Remove from My Day
						</Dropdown.Item>
						<Dropdown.Item>
							<i class="bi bi-star"></i>Mark as important
						</Dropdown.Item>
						<Dropdown.Item>
							<i class="bi bi-check-circle"></i>Mark as completed
						</Dropdown.Item>
						<Dropdown.Item onClick={toggleShowConfirmModal} className="delete-task">
